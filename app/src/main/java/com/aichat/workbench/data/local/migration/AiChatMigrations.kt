package com.aichat.workbench.data.local.migration

import androidx.room.migration.Migration
import androidx.sqlite.db.SupportSQLiteDatabase
import com.aichat.workbench.data.local.recreateConversationsWithSchema

internal object AiChatMigrations {
