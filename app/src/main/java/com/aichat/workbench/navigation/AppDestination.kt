...
sealed class AppDestination(
    ...
    data object Providers : AppDestination("providers", "模型连接", "配置模型 Provider")
    data object Prompts : AppDestination("prompts", "提示词", "管理本地 Prompt 预设")
    data object Images : AppDestination("images", "图片", "生成并查看图片")
    data object Tools : AppDestination("tools", "工具", "配置可选 Gateway 工具")
